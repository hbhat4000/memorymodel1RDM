...
for ((delay=10;delay<=1110;delay+=10)); do
    ...
    target_file="./6-31gss/fci_h2_6-31gss_0.025000_${delay}_0.063988_0.100000_5.txt"
    ...
    ./memoryFO --time 0.025,200.0 --field -1,0.1,5 --delay $delay --infile ../psi4data/fci_h2_6-31gss.npz --outpath ./6-31gss/ --g0 0 --g1 1 --verbose
done
